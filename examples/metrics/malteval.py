...
#make sure you have you MaltEval.jar pointed by MALTEVALHOME (or pass jar as argument)
malteval = Malteval()
...
#this is example of so called complex group by which is used rarely but can be specified
