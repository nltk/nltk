...
def zen_chat():
    safe_print("*" * 75)
    safe_print("Zen Chatbot!".center(75))
    safe_print("*" * 75)
    safe_print('"Look beyond mere words and letters - look into your mind"'.center(75))
    safe_print("* Talk your way to truth with Zen Chatbot.")
    safe_print("* Type 'quit' when you have had enough.")
    safe_print("*" * 75)
    safe_print("Welcome, my child.")
