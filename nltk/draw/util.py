...
class CanvasWidget(object):
    ...
    def moveto(self, x, y, anchor='NW'):
        ...
        :param x: The x-coordinate of the location that the canvas widget should be moved
            to.
        :param y: The x-coordinate of the location that the canvas widget should be moved
            to.
