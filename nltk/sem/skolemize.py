...
def skolemize(expression, univ_scope=None, used_variables=None):
    ...
    if isinstance(expression, AllExpression):
        term = skolemize(expression.term, univ_scope | set(
            [expression.variable]), used_variables | set([expression.variable]))
        ...
        if isinstance(negated, AllExpression):
            ...
            term = skolemize(-negated.term, univ_scope |
                             set([negated.variable]), used_variables | set([negated.variable]))
