...
class RecursiveDescentParser(ParserI):
    ...
    def _parse(self, remaining_text, tree, frontier):
        ...
        :param tree: A partial structure for the text that is
            ...
            expanded or matched.
        :type remaining_text: list of C{String}s
    ...
    def _production_to_tree(self, production):
        """
        :rtype: Tree
        :return: The Tree that is licensed by C{production}.
...
#            c[pos] = c[pos].freeze()
    ...
    def step(self):
        ...
        :rtype: C{Production} or C{String} or bool
        """
