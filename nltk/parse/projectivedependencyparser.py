...
class ProjectiveDependencyParser(object):
    ...
    def concatenate(self, span1, span2):
        ...
        if self._grammar.contains(
            ...
            new_arcs[
                span2._head_index - span1._start_index
            ] = span1._head_index
            spans.append(
                DependencySpan(
                    span1._start_index,
        ...
        if self._grammar.contains(
            ...
            new_arcs[
                span1._head_index - span1._start_index
            ] = span2._head_index
            spans.append(
                DependencySpan(
                    span1._start_index,
            ...
            for node_index in range(1, len(dg.nodes)):
                ...
                for child_index in range(
                    ...
                    if child_index < 0:
                        ...
                        if child_index != -1:
                            prev_word = dg.nodes[children[array_index + 1]][
                                "word"
                            ]
                            prev_tag = dg.nodes[children[array_index + 1]][
                                "tag"
                            ]
                        if child != "STOP":
                            productions.append(
