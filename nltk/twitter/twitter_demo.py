...
def twitterclass_demo():
    ...
    """
    tw = Twitter()
    safe_print("Track from the public stream\n")
    tw.tweets(keywords="love, hate", limit=10)  # public stream
    safe_print(SPACER)
    safe_print("Search past Tweets\n")
    tw = Twitter()
