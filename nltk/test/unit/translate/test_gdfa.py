...
class TestGDFA(unittest.TestCase):
    def test_from_eflomal_outputs(self):
        ...
        expected = [ [(0, 0), (1, 2)],
                     ...
                     [(0, 0), (1, 1), (1, 2), (2, 3), (3, 4), (4, 5), (4, 6), (5, 7), (6, 8), (7, 5)],
                     [(0, 0), (1, 8), (2, 9), (3, 10), (4, 11), (5, 8), (6, 9), (6, 11), (7, 10), (8, 11)],
                     [(0, 0), (0, 2), (1, 1), (2, 3)],
                     [(0, 0), (1, 1), (2, 2), (2, 3), (4, 4)],
                     [(0, 0), (1, 1), (2, 3), (3, 4), (5, 5), (7, 6), (8, 7), (9, 8), (10, 9), (11, 10)],
                     [(0, 0), (1, 1), (3, 0), (3, 2), (4, 1), (5, 3), (6, 2), (6, 4), (7, 5), (8, 6)],
                     [(1, 0)],
                   ]
