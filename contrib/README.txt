###############################################################
###  Natural Language Toolkit (NLTK) Contributions Package  ###
###~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~###
...
~~~~~~~~~~~~~~~~~~~~~
    This package contains third-party contributions to the NLTK.
    These Python programs are designed to work with NLTK, and perform
    a wide variety of natural language processing tasks.  While they
    are not integrated into NLTK (yet), these programs may be of
    interest to NLTK developers and to people teaching NLP using
    Python.

    Contributed modules are organized using a hierarchy of Python
    packages.  For a description of the packages and modules included
    in the contributions package, see its reference documentation:

        <http://nltk.sourceforge.net/contrib>
...
~~~~~~~~~~~~~
    There are three mailing lists associated with NTLK:
      ...
      - nltk-teach: Discussions amongst people teaching with NLTK
    ...
    To subscribe:
      ...
      - NLTK-Teach: please contact Steven Bird
