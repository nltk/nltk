...
# Contributions from the University of Pennsylvania: CIS-530/spring2005
#
# Copyright (C) 2005 The original contributors
# URL: <http://nltk.sf.net>
#
# $Id$

"""
Student projects from the course CIS-530, taught in Spring of 2005 at
