...
\+mkr 1d
\nam First dual
\desc Used to give the vernacular for this particular paradigm form. (It is better to use the new \pdl field set for this.)
\lng vernacular
\mkrOverThis ps
\CharStyle
\-mkr
...
\+mkr dr
\nam Definition (r)
\desc Used to fully express the semantic domains of each sense of a lexeme in the regional language. May be verbose. Other fields (\er, \ur, and \or) provide for expanded information.
\lng regional
\mkrOverThis sn
\CharStyle
\-mkr
...
\desc The regional language equivalent to the \ee field. It should cover any information that provides a more complete knowledge-base on the lexeme.
\lng regional
\mkrOverThis sn
\CharStyle
\-mkr
...
\+mkr es
\nam Etymology source
\desc The reference or source abbreviation for etymology of the lexeme is given here.
\lng English
\mkrOverThis et
\CharStyle
\-mkr
...
\+mkr gr
\nam Gloss (r)
\desc Intended for interlinear morpheme-level glossing. Since MDF does not create a reversed index for the regional language, this field is not used for this. But the contents of this field are used as a regional language definition in a formatted dictionary if there is no \dr field (or it is present but empty).
\lng regional
\mkrOverThis sn
\CharStyle
\-mkr
...
\desc Used to catalog lexical entries according to an etic (published) list of possible semantic domains. Sorting on this field would then garher semantically related entries.
\lng English
\mkrOverThis sn
\CharStyle
\-mkr
...
\+mkr lt
\nam Literally
\desc Used to elucidate the destinct meanings of the parts of an idiom or complex phrase in a lexical entry (\lx) or subentry (\se).
\lng English
\mkrOverThis sn
\CharStyle
\-mkr
...
\desc This field is for any ethnographic note that is pertinent to the lexeme that you wish to keep separate from general notes.
\lng English
\mkrOverThis sn
\CharStyle
\-mkr
...
\+mkr nd
\nam Notes (discourse)
\desc This field is for any dicourse/text analysis notes that are pertinent to the lexeme that you wish to keep separate from general notes.
\lng English
\mkrOverThis sn
\CharStyle
\-mkr
...
\+mkr ng
\nam Notes (grammar)
\desc This field is for any grammar notes that are pertinent to the lexeme that you wish to keep separate from general notes.
\lng English
\mkrOverThis sn
\CharStyle
\-mkr
...
\+mkr np
\nam Notes (phonology)
\desc This field is for any phonology notes that are pertinent to the lexeme that you wish to keep separate from general notes.
\lng English
\mkrOverThis sn
\CharStyle
\-mkr
...
\+mkr nq
\nam Notes (questions)
\desc This field is for any questions or notes for further sudy pertinent to the lexeme that you wish to keep separate from general notes.
\lng English
\mkrOverThis sn
\CharStyle
\-mkr
...
\desc This field is for any sociolinguistics notes that are pertinent to the lexeme that you wish to keep separate from general notes.
\lng English
\mkrOverThis sn
\CharStyle
\-mkr
...
\desc For denoting in English any semantic and/or grammatical restrictions pertinent to the lexeme.
\lng English
\mkrOverThis sn
\CharStyle
\-mkr
...
\desc For denoting in the national language any semantic and/or grammatical restrictions pertinent to the lexeme.
\lng national
\mkrOverThis sn
\CharStyle
\-mkr
...
\desc For denoting in the regional language any semantic and/or grammatical restrictions pertinent to the lexeme.
\lng regional
\mkrOverThis sn
\CharStyle
\-mkr
...
\desc This field contains the vernacular description of any semantic and/or grammatical restrictions pertinent to the lexeme or headword. This is intended for use in a monolingual dictionary, but can be used in diglot and triglot dictionaries as well.
\lng vernacular
\mkrOverThis sn
\CharStyle
\-mkr
...
\+mkr pdl
\nam Paradigm label
\desc Used to label the paradigm form given in the \pdv field. This is useful for paradigm sets which are incomplete or irregular.
\lng English
\+fnt 
\Name Times New Roman
\Size 11
...
\+mkr ph
\nam Phonetic form
\desc Used as needed to retain the phonetic information that is lost when an orthographic spelling is used for an entry.
\lng phonetic
\mkrOverThis se
\CharStyle
\-mkr
...
\+mkr pl
\nam Plural form
\desc This is a special paradigm field used to give the plural form of the lexeme. (It is now better to use the new \pdl field set for this.)
\lng vernacular
\mkrOverThis ps
\CharStyle
\-mkr
...
\+mkr pn
\nam Part of speech (n)
\desc Used to classify the part of speech with labels found in national language dictionaries. Consistent labeling is important. Use the Range Set feature for this field.
\lng national
\mkrOverThis ps
\CharStyle
\-mkr
...
\+mkr rr
\nam Reversal (r)
\desc Gives the regional language word or phrase that could be used to reverse the dictionary for a regional audience. Currently MDF does not support exporting a regional audience index.
\lng regional
\mkrOverThis sn
\CharStyle
\-mkr
...
\+mkr sg
\nam Singular form
\desc This is a special paradigm field used to give the singular form of the lexeme. (It is now better to use the new \pdl field set for this.)
\lng vernacular
\mkrOverThis ps
\CharStyle
\-mkr
...
\+mkr st
\nam Status
\desc Used to indicate how complete or thoroughly checked an entry is.
\lng English
\mkrOverThis lx
\CharStyle
\-mkr
...
\+mkr ue
\nam Usage (E)
\desc This field should cover, in English, such information as common usage, or restrictions in usage (such as taboos) that is needed so a non-native speaker can use this lexeme properly.
\lng English
\mkrOverThis sn
\CharStyle
\-mkr
...
\+mkr ur
\nam Usage (r)
\desc This field should cover, in the regional language, such information as common usage, or restrictions in usage (such as taboos) that is needed so a non-native speaker can use this lexeme properly.
\lng regional
\mkrOverThis sn
\CharStyle
\-mkr
...
\+mkr uv
\nam Usage (v)
\desc This field contains the vernacular description of common usage, or restrictions in usage (such as taboos) that is needed to describe the lexeme more fully. Intended for use in a monolingual dictionary, but can be used in diglot and triglot dictionaries as well.
\lng vernacular
\mkrOverThis sn
\CharStyle
\-mkr
...
\desc Gives the English gloss to be used in word-level interlinear glossing.
\lng English
\mkrOverThis sn
\CharStyle
\-mkr
...
\desc Gives the national language gloss to be used in word-level interlinear glossing.
\lng national
\mkrOverThis sn
\CharStyle
\-mkr
...
\desc Gives the regional language gloss to be used in word-level interlinear glossing.
\lng regional
\mkrOverThis sn
\CharStyle
\-mkr
...
\desc This provides the regional language translation of the example sentence given in the \xv field.
\lng regional
\mkrOverThis xv
\CharStyle
\-mkr
