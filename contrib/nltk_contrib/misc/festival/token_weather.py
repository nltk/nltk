...
# VERSION 2: Uses the Speech Tokenizer
#
...
to the SpeechTokenizer and the tts module to be converted to speech.
...
import nltk_contrib.misc.festival.token_tts as token_tts
...
if x:
	...
	token_tts.initialize()
	token_tts.say_text(text)
