...
class FileTestCase(unittest.TestCase):
    def test_file_read_operation(self):
        self.contents = ""
        f = cfile.File(datasetsDir(self) + 'test_phones' + SEP + 'phoney', format.C45_FORMAT.NAMES)
    ...
    def test_name_extension(self):
        basename, extension = cfile.name_extension('/home/something.something/else/test_phones' + SEP + 'phoney.' + format.C45_FORMAT.NAMES)
