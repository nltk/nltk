...
from nltk_lite_contrib.classifier.exceptions import filenotfounderror as fnf, invaliddataerror as inv
from nltk_lite_contrib.classifier import instances as ins, attributes as attrs
