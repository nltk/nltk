"""Push NLTK words corpus to nltk-data-hub/words on HuggingFace.

One config per word list (en, en-basic), one parquet file per config.
...
def main():
    ...
    print(f"  {len(CONFIGS)} configs, {total:,} total words")
