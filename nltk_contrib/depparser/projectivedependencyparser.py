...
def nonprojective_prob_parse_demo():
	...
	npp.train(graphs)
	npp.test_parse(['Cathy', 'zag', 'hen', 'zwaaien', '.'], ['N', 'V', 'Pron', 'Adj', 'N', 'Punc'])
#	npp.parse(['v1', 'v2', 'v3'])
	test = 'something %sing' %('test')
	print len(test)
	print test
...
def projective_prob_parse_demo():
	print
	print 'Demoing ProbabilisticProjectiveDependencyParser...'
	infile = open('conll_sample.txt',"r")
	graphs = []
	entry = ""
	for line in infile.readlines():
