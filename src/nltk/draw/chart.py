...
class ChartView:
    ...
    def update(self, chart=None, source=None):
        """
...
class ChartDemo:
    ...
    def __init__(self, grammar, text, title='Chart Parsing Demo'):
        ...
        try:
            ...
            self._rulelabel1 = Tkinter.Label(buttons1,text=ruletxt)
            self._rulelabel2 = Tkinter.Label(buttons1, width=30,
            ...
            self._rulelabel1.configure(font=('helvetica', -size, 'bold'))
            self._rulelabel2.configure(font=('helvetica', -size, 'bold'))
    ...
    def resize(self):
        ...
        self._rulelabel1['font'] = ('helvetica', -size, 'bold')
        self._rulelabel2['font'] = ('helvetica', -size, 'bold')
    ...
    def edit_sentence(self, *e):
        sentence = ' '.join([tok.type() for tok in self._tok_sent])
        title = 'Edit Text'
        EntryDialog(self._root, sentence, self.set_sentence, title)

    def set_sentence(self, sentence):
        self._tok_sent = WSTokenizer().tokenize(sentence)
        self.reset()
    ...
    def reset(self, *e):
        ...
        self._cp.initialize(self._tok_sent)
        self._chart = self._cp.chart()
        self._cv.update(self._chart, self._tok_sent)
