...
from nltk.draw import ColorizedList, SymbolWidget
...
#            self._edgeselection = None
            ...
            #if self._smallmatrix is not None:
...
class PseudoEarleyRule(AbstractChartRule):
    ...
    def apply_iter(self, chart, grammar, edge):
        ...
        for e in self._completer.apply_iter(chart, grammar, edge):
            ...
            yield e
    def __str__(self):
        # Report the rule name of the rule that we used most recently.
        return str(self._most_recent_rule)
...
class ChartDemo:
    ...
    def _init_rulelabel(self, parent):
        ...
        self._rulelabel2 = Tkinter.Label(parent, width=30,
    ...
    def _init_menubar(self):
        ...
        viewmenu.add_command(label='View Matrix', underline=5,
    ...
    def view_matrix(self, *e):
        if self._matrix is None:
            self._matrix = SmallChartMatrixView(self._root, self._chart)
...
def demo():
    ...
    grammar_rules1 = [
        ...
        CFGProduction(VP, V),       CFGProduction(P, 'with'),
        CFGProduction(N, 'fork'),   CFGProduction(N, 'cake')
        ]
