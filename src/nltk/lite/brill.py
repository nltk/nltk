...
def test(numSents=100, max_rules=200, min_score=2, ruleFile="dump.rules",
    ...
    u = UnigramTagger(backoff=NN_CD_tagger)
    ...
    #trainer = FastBrillTaggerTrainer(u, templates, trace)
    trainer = BrillTaggerTrainer(u, templates, trace)
